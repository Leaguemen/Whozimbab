...
class Pilihan:
    def __init__(self ,option, correctness):
        self.option= option
...
print("################################")
question_list = ["What is the height of the Eifell Tower? 200 m | 300 m | 250 m", 
"Who is the first President of Indonesia? Soekarno | B.J. Habiebie | Salman", "On what year did the bomb of Hiroshima was dropped ? 1944|1947|1945", 
"Table salt has the scientifical name of ... Magnesium Sulfide | Sodium Chloride | Sulfuric Acid"]
